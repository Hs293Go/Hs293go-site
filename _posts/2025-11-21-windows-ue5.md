...
``` powershell
& "C:\Program Files\Epic Games\UE_5.5\Engine\Binaries\DotNET\AutomationTool\UnrealBuildTool.exe" -Mode=GenerateClangDatabase -Target=UnrealEditor Development Win6
```
